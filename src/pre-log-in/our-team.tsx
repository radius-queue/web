  ...
  return (
    <div>
      <div id='landing-page-display'>
        <h1>Meet the Team</h1>
        <p>We Love Solving Problems and Helping You Safely Serve Your Customers.</p>
      </div>
      <Container style={{marginTop: '30px'}}>
        <Row md={2} sm={1} xs={1}>
          ...
          <Col>
            <div className='image-crop'>
              <img src='../images/grant-portrait.jpg'
                alt='Grant Williams'
              />
            </div>
            ...
            <div className='link-box'>
              ...
              <a href='https://www.linkedin.com/in/grant-williams-uwcompe/' target='_blank'>
                <img src='../images/linked-in.png'
                  alt='LinkedIn Link'
                  id='linked-in'
                />
              </a>
              <a href='https://www.facebook.com/grant.williams.397' target='_blank'>
                <img src='../images/facebook.png'
                  alt='Facebook Link'
                />
              </a>
            ...
            <div className='member-bio'>
              <p>
                Grant is an aspiring software engineer studying at the University of Washington.
                Among other things, he’s known for his hatred towards Mark Zuckerberg. A soccer fanatic,
                he’s a staple of the UW Club Soccer team and enjoys watching the English Premier League.
        ...
        <Row md={2} sm={1} xs={1}>
          <Col className='single-team-member'>
            <div className='image-crop'>
              <img src='../images/wes-portrait.jpg'
                alt='Wesley Lam'
              />
            </div>
            <h2>Wesley Lam</h2>
            <div className='link-box'>
              ...
              <a href='https://www.linkedin.com/in/wesley-lam-43562a170/' target='_blank'>
                <img src='../images/linked-in.png'
                  alt='LinkedIn Link'
                  id='linked-in'
                />
            ...
            <div className='member-bio'>
              <p>
                Wesley is currently a junior at the University of Washington majoring in computer science.
                Upon entering UW as a college of engineering admit, he was inspired to change course in his
                studies after taking the introductory computer science series, and decided to pursue a degree
                in the Allen school of CSE. Outside of school, Wesley is invested in giving back to his community,
                leading a tutoring program for Dearborn Elementary students in the past two years. As an aspiring
                professional, Wesley hopes to achieve a career as a software engineer, with a particular emphasis
                on redesigning educational platforms that are accessible to students of all backgrounds. As hobbies,
                Wesley enjoys hiking in the great PNW, playing the guitar, and hitting the courts for a game of pickup
                basketball.
              </p>
            </div>
          </Col>
